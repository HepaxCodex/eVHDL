...
public class VHDLAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected VHDLSwitch<Adapter> modelSwitch =
    ...
    {
      @Override
      public Adapter casevHDLPagckage(vHDLPagckage object)
      {
        return createvHDLPagckageAdapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.hepaxcodex.eVHDL.vHDL.vHDLPagckage <em>vHDL Pagckage</em>}'.
   * <!-- begin-user-doc -->
   ...
   * @generated
   */
  public Adapter createvHDLPagckageAdapter()
  {
    return null;
  }
